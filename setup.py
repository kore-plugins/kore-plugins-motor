...
init_path = os.path.join('kore_plugins_motor', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.motor =\
    kore_plugins_motor.plugins.config:MotorPluginComponent
kore.components.motor.asyncio =\
    kore_plugins_motor.plugins.asyncio:AsyncioMotorPluginComponent
"""


setup(
    name='kore-plugins-motor',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_motor*',)),
